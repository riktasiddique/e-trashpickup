                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="{{asset('admin/images/admin.jp')}}g" alt="User Avatar">
                        </a>
                        ...
                        <div class="user-menu dropdown-menu">
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                ...
                                <a class="nav-link" href="" :href="route('logout')"
                                        onclick="event.preventDefault();this.closest('form').submit();"><i class="fa fa-power -off"></i>Logout</a>
                            </form>
                        </div>
                    </div>
