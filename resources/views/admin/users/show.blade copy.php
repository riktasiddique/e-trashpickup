...
<div class="row justify-content-center">
    <div class="col-md-5">
        <div class="card">
            ...
            @endif
            <a href="" class="btn btn-success">change Role</a>
            
            <!-- @if(auth()->user()->id !== $user->id)
                <a href="" data-toggle="modal" data-target="#changerole" class="btn btn-warning">Change Role</a> 
            @endif -->
            <hr>
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{route('user.change_role', $user->id)}}" method="post" require>
                                @csrf
